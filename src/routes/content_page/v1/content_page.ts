...
export default (contentPageController: ContentPageController) => {
  router.get('/get-all', Authentication(), contentPageController.getAllPages.bind(contentPageController));
  router.get('/get-one', Authentication(), contentPageController.getPageById.bind(contentPageController));
