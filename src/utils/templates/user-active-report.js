...
<html lang='en'>
  <head>
    ...
    <title>ACTIVE CUSTOMERS REPORT - {{printNotNull data.headers.name}}</title>
    <style>
      @page {
        size: A4 landscape;
        margin: 10mm;
    ...
    <div class='report-container'>
      <div class='header' style='position: sticky; top: 0; background: #fff'>
        ...
        <div class='report-info'>
          <strong><u>ACTIVE CUSTOMERS REPORT</u></strong>
          <p>
